 ...
 * Continue follows: Layout → Contact → Summary → Skills → Experience → Edu → Certs → This resume.
 */
    ...
    <div className="no-print flex flex-wrap items-center justify-between gap-2 rounded-xl border border-slate-700 bg-slate-900/70 px-3 py-2.5">
      <div className="min-w-0">
        <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-500">
          {activeLabel ? 'This resume' : 'Master bank'} · resume order
        </p>
        <p className="truncate text-sm text-slate-200">
          {activeLabel ? (
            ...
            <span className="text-slate-400">
              No resume yet — use New resume for a role
            </span>
          )}
