...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  {
    id: 'master-vs-builds',
    title: 'Master profile vs builds',
    ...
    bullets: [
      ...
      'Build (version) = one resume aimed at a job or company — which jobs/skills print, summary tone, layout, JD keywords',
      'Use + New Build for each target (for example Jr. Development Tech vs Machine Operator)',
      'Switch builds with the dropdown at the top — master history stays shared',
    ],
    tip: 'Do not clear your master profile for each application. Create another build instead.',
  },
  {
    id: 'path',
    ...
    bullets: [
      ...
      '3 · Summary — short professional summary for this build (or use the master summary)',
      '4 · Skills — bank of hard / tools / soft skills; each build can check which print',
      '5 · Experience — every role you might need; jobs auto-sort newest first by dates',
      '6–7 · Education & certs — schools and credentials',
      '8 · This build — which jobs/skills print, emails, tone for this version',
    ],
  ...
  },
  {
    ...
    body: 'When you have a posting (or a clear title), tailor a build — not a second career history.',
    bullets: [
      'Tap + New Build → set target title/company and a clear name',
      'On This build, check only the jobs and skills that support that role',
      ...
      'Download PDF from that build — switch builds later for the next application',
    ],
